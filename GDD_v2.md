...
**Supersedes:** GDD.md (v0.8) �3 Mechanics and �5 End-of-Round Resolution
**Companion document:** RULES_v2.md (to be drafted after this document is approved)
...
For 5�8 player matches, additional asymmetric tribes will be defined in RULES_v2.md.
...
- The existing monorepo (`packages/engine`, `packages/web`, `tools/`).
...
- `GDD.md` (v0.8) to be moved to `docs/legacy/GDD_v0.8.md` when v2 is approved.
- `RULES.md` (v0.8) to `docs/legacy/RULES_v0.8.md`.
- Existing simulations (`simulations/batch_v0.8.jsonl` etc.) kept as-is � they document the old engine's behavior and are not replayable under v2 rules.

---

## 11. Deferred to RULES_v2.md

The following need precise numbers before any code can be written. They belong in RULES_v2.md, which will be drafted after this document is approved:
...
- A sample match can be narrated tick-by-tick by reading only this document and RULES_v2.md (no engine required).
...
*End of GDD_v2.md. RULES_v2.md to follow upon approval.*