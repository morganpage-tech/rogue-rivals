/**
 * Serialize GameState to the same JSON shape as legacy Python `_state_snapshot`
 * (snake_case). Ported from packages/web/src/replay/serializeGameStateForReplay.ts.
 */
